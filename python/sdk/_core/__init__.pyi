...
class SdkFullConfig:
    ...
    def __new__(cls, api_key: builtins.str, http: typing.Optional[HttpConfig] = None, admin: typing.Optional[AdminConfig] = None, streams: typing.Optional[StreamsConfig] = None) -> SdkFullConfig: ...
...
class Stream:
    ...
    @start_range.setter
    def start_range(self, value: builtins.int) -> None: ...
    @property
    def end_range(self) -> builtins.int: ...
    @end_range.setter
    def end_range(self, value: builtins.int) -> None: ...
    @property
    def plan(self) -> typing.Optional[builtins.str]: ...
    @plan.setter
    def plan(self, value: typing.Optional[builtins.str]) -> None: ...
    @property
    def threshold_fetch_buffer(self) -> typing.Optional[builtins.int]: ...
    @threshold_fetch_buffer.setter
    def threshold_fetch_buffer(self, value: typing.Optional[builtins.int]) -> None: ...
    @property
    def dataset_batch_size(self) -> typing.Optional[builtins.int]: ...
    @dataset_batch_size.setter
    def dataset_batch_size(self, value: typing.Optional[builtins.int]) -> None: ...
    @property
    ...
    @max_buffer_range_size.setter
    def max_buffer_range_size(self, value: typing.Optional[builtins.int]) -> None: ...
    @property
    def max_buffer_processing_workers(self) -> typing.Optional[builtins.int]: ...
    @max_buffer_processing_workers.setter
    def max_buffer_processing_workers(self, value: typing.Optional[builtins.int]) -> None: ...
    @property
    def keep_distance_from_tip(self) -> typing.Optional[builtins.int]: ...
    @keep_distance_from_tip.setter
    def keep_distance_from_tip(self, value: typing.Optional[builtins.int]) -> None: ...
    @property
    def filter_function(self) -> typing.Optional[builtins.str]: ...
    @filter_function.setter
    def filter_function(self, value: typing.Optional[builtins.str]) -> None: ...
    @property
    def filter_language(self) -> typing.Optional[builtins.str]: ...
    @filter_language.setter
    def filter_language(self, value: typing.Optional[builtins.str]) -> None: ...
    @property
    def include_stream_metadata(self) -> typing.Optional[builtins.str]: ...
    @include_stream_metadata.setter
    def include_stream_metadata(self, value: typing.Optional[builtins.str]) -> None: ...
    @property
    ...
    @fix_block_reorgs.setter
    def fix_block_reorgs(self, value: typing.Optional[builtins.int]) -> None: ...
    @property
...
class WebhookAttributes:
    ...
    def __new__(cls, url: builtins.str, max_retry: builtins.int, retry_interval_sec: builtins.int, post_timeout_sec: builtins.int, security_token: typing.Optional[builtins.str] = None, compression: typing.Optional[builtins.str] = None) -> WebhookAttributes: ...
