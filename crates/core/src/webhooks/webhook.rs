...
mod python_repr_impls {
    use super::*;
    crate::python_repr_dict!(EvmWalletFilterTemplate);
    crate::python_repr_dict!(EvmContractEventsTemplate);
    crate::python_repr_dict!(EvmAbiFilterTemplate);
    crate::python_repr_dict!(SolanaWalletFilterTemplate);
    crate::python_repr_dict!(BitcoinWalletFilterTemplate);
    crate::python_repr_dict!(XrplWalletFilterTemplate);
    crate::python_repr_dict!(HyperliquidWalletEventsFilterTemplate);
    crate::python_repr_dict!(StellarWalletTransactionsFilterTemplate);
    crate::python_repr_dict!(WebhookDestinationAttributes);
    crate::python_repr_dict!(GetWebhooksParams);
    crate::python_repr_dict!(UpdateWebhookParams);
    crate::python_repr_dict!(Webhook);
    crate::python_repr_dict!(WebhookPageInfo);
    crate::python_repr_dict!(ListWebhooksResponse);
    crate::python_repr_dict!(WebhookEnabledCountResponse);
}
