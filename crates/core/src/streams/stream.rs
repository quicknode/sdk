...
mod python_repr_impls {
    use super::*;
    crate::python_repr_dict!(WebhookAttributes);
    crate::python_repr_dict!(S3Attributes);
    crate::python_repr_dict!(AzureAttributes);
    crate::python_repr_dict!(PostgresAttributes);
    crate::python_repr_dict!(KafkaAttributes);
    crate::python_repr_dict!(AddressBookConfig);
    crate::python_repr_dict!(PageInfo);
    crate::python_repr_dict!(TestFilterResponse);
    crate::python_repr_dict!(EnabledCountResponse);
}
