...
mod python_repr_impls {
    use super::*;
    crate::python_repr_dict!(KvSetEntry);
    crate::python_repr_dict!(GetSetsResponse);
    crate::python_repr_dict!(GetSetResponse);
    crate::python_repr_dict!(GetListsData);
    crate::python_repr_dict!(GetListsResponse);
    crate::python_repr_dict!(GetListData);
    crate::python_repr_dict!(GetListResponse);
    crate::python_repr_dict!(ListContainsItemResponse);
}
