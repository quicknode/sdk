  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '3.1.0-alpha.27' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 3.1.0-alpha.27 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
    try {
      wasiBinding = require('@quicknode/sdk-wasm32-wasi')
      nativeBinding = wasiBinding
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
        if (!wasiBindingError) {
...
module.exports.FilterLanguage = nativeBinding.FilterLanguage
module.exports.ProductType = nativeBinding.ProductType
module.exports.StreamDataset = nativeBinding.StreamDataset
module.exports.StreamDestination = nativeBinding.StreamDestination
module.exports.StreamMetadataLocation = nativeBinding.StreamMetadataLocation
module.exports.StreamRegion = nativeBinding.StreamRegion
module.exports.StreamStatus = nativeBinding.StreamStatus
module.exports.WebhookStartFrom = nativeBinding.WebhookStartFrom
module.exports.WebhookTemplateId = nativeBinding.WebhookTemplateId
